...
log("liao,,",__dirname);
var private_key = fs.readFileSync(PreviousDirectory + '/resource/rsa/rsa_private_key.pem','utf-8');
var public_key = fs.readFileSync(PreviousDirectory + '/resource/rsa/rsa_public_key.pem','utf-8');
